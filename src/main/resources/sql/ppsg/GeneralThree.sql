...
`remark1` VARCHAR(32)  DEFAULT NULL  COMMENT '备注1',
`remark2` VARCHAR(32)  DEFAULT NULL  COMMENT '备注2',
PRIMARY KEY (`id`)
...
ALTER TABLE `ppsg_general_three` ADD COLUMN remark1 VARCHAR(32)  DEFAULT NULL  COMMENT '备注1';
ALTER TABLE `ppsg_general_three` ADD COLUMN remark2 VARCHAR(32)  DEFAULT NULL  COMMENT '备注2';
